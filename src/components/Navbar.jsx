    ...
    <nav className="fixed top-0 left-0 right-0 z-50 bg-warm-white/90 backdrop-blur-sm transition-all duration-300 border-b border-muted-taupe/20">
      <div className="max-w-[1600px] mx-auto px-6 py-6 flex items-center justify-between">
        ...
        <div className="flex-1 flex justify-end items-center space-x-6">
          <button className="hover:text-sunset-orange transition-colors" aria-label="Search">
            <Search size={20} strokeWidth={1.5} />
          </button>
          <button className="hover:text-sunset-orange transition-colors" aria-label="Wishlist">
            <Heart size={20} strokeWidth={1.5} />
          </button>
          <button className="hover:text-sunset-orange transition-colors relative" aria-label="Cart">
