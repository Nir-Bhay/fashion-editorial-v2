...
function App() {
  ...
  const handleLoadMore = () => {
    setIsLoading(true);
    setAriaLiveText('Loading more items...');

    setTimeout(() => {
      setIsLoading(false);
      setAriaLiveText('Successfully loaded more items');
    }, 1500);
  };
