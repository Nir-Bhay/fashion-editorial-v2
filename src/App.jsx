...
function App() {
  ...
  useEffect(() => {
    ...
    if (isLoadingMore) {
      timer1 = setTimeout(() => {
        ...
        setLoadMessage('Successfully loaded 9 more items.');
      }, 2000);
    }
  ...
  useEffect(() => {
    let timer2;
    if (loadMessage === 'Successfully loaded 9 more items.') {
      timer2 = setTimeout(() => {
        setLoadMessage('');
      }, 3000);
    }
  ...
  const handleLoadMore = () => {
    ...
    setLoadMessage('Loading more items...');
  };
            ...
            <div className="col-span-12 lg:col-span-10">
              ...
              <div className="mt-24 flex flex-col items-center justify-center space-y-4">
                 ...
                 <button
                   ...
                   className={`px-12 py-4 flex items-center justify-center space-x-2 border border-charcoal text-sm uppercase tracking-widest transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-charcoal focus-visible:ring-offset-2 rounded-sm ${
                     isLoadingMore ? 'opacity-50 cursor-not-allowed bg-warm-white text-charcoal' : 'hover:bg-charcoal hover:text-white'
                   }`}
                 >
                    {isLoadingMore && (
