...
function App() {
  ...
  const [loadMoreFeedback, setLoadMoreFeedback] = useState('');
  ...
  useEffect(() => {
    ...
    if (isLoadingMore) {
      timer = setTimeout(() => {
        ...
        setLoadMoreFeedback('Successfully loaded more products.');
      }, 2000);
    }
  ...
  const handleLoadMore = (e) => {
    ...
    setLoadMoreFeedback('Loading more products...');
  };
            ...
            <div className="col-span-12 lg:col-span-10">
              ...
              <div className="mt-24 flex flex-col items-center">
                 ...
                 <button
                   ...
                   className={`flex items-center justify-center space-x-2 px-12 py-4 border border-charcoal text-sm uppercase tracking-widest transition-colors duration-300 focus:outline-none focus-visible:ring-2 focus-visible:ring-charcoal focus-visible:ring-offset-2 rounded-sm ${
                     isLoadingMore
