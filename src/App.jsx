...
function App() {
  ...
  useEffect(() => {
    if (loadSuccess) {
      const timer = setTimeout(() => setLoadSuccess(false), 2000);
      return () => clearTimeout(timer);
    }
  }, [loadSuccess]);
            ...
            <div className="col-span-12 lg:col-span-10">
              ...
              <div className="mt-24 flex flex-col items-center">
                 <div aria-live="polite" className="sr-only">
                    {isLoading ? 'Loading more items...' : loadSuccess ? 'Successfully loaded more items.' : ''}
                 </div>
                 <button
                    onClick={() => !isLoading && !loadSuccess && setIsLoading(true)}
                    disabled={isLoading || loadSuccess}
